...
$(build_tag): requirements.txt $(checks_tag) snap/snapcraft.yaml
	make checks
	@echo "==Building SNAP=="
	snapcraft
...
$(k8s_tag):
	...
	sudo microk8s config | tee /home/${USER}/.kube/config
...
clean:
	...
	rm -rf *.egg-info .mypy_cache .mypy .tox .pytest_cache .make_cache .coverage $(install_tag) $(package_dir)/.build-tag
